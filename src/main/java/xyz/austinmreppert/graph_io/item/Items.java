...
public class Items {
  ...
  public static final Item BASIC_ROUTER_CORE = register(new IdentifierItem(new Item.Properties().tab(ItemGroups.GRAPH_IO)), "basic_router_core");
  public static final Item ADVANCED_ROUTER_CORE = register(new IdentifierItem(new Item.Properties().tab(ItemGroups.GRAPH_IO)), "advanced_router_core");
  public static final Item ELITE_ROUTER_CORE = register(new IdentifierItem(new Item.Properties().tab(ItemGroups.GRAPH_IO)), "elite_router_core");
  public static final Item ULTIMATE_ROUTER_CORE = register(new IdentifierItem(new Item.Properties().tab(ItemGroups.GRAPH_IO)), "ultimate_router_core");
